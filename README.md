...
## Features
- Realistic terminal input
- `cd`, `ls`, `cat`, `history` support
- Custom `neofetch` output
- Mobile optimized
- Pure Vanilla JS
...
## Setup
```bash
git clone https://github.com/jrtkl44/JR-TORIKUL-x-TERMINAL
cd JR-TORIKUL-x-TERMINAL
```
Open `index.html`
